...
import { CardBGHover } from '../components/ui/Card-bg-hover';
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[400px] md:h-[500px] w-full">
        <Image
          src="/assets/about-us-page-banner.jpg"
          alt="About Us Banner"
          fill
          className="object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#6d0000]/50 to-[#8a0000]/50 flex items-center justify-center">
      ...
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto bg-[#6d0000]">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white font-Forum">Creating A Beautiful World</h2>
      ...
      <section className="py-16 bg-[#6d0000]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <CardBGHover list={carbghoverData} />
          </div>
        </div>
      </section>
