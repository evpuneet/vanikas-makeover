...
export default function MeetOurOwner() {
  return (
    <>
        <section className='lg:h-[550px] h-[100%] bg-white py-[50px]'>
            <h2 className='text-[50px] font-Forum font-medium text-primary text-center mb-[40px]'>Meet The Owner</h2>
            <div className='w-[80%] mx-auto grid lg:grid-cols-2 grid-cols-1 items-center lg:place-items-start place-items-center '>
                <div className='lg:w-[auto] w-[200px]'>
                    <Image src="/assets/vanikas.png" className='bg-primary rounded-full shadow-[4px_5px_10px_rgba(0,0,0,0.4)]' width={300} height={300} alt='Owner Image'/>
                </div>
                <div className='text-primary text-center mb-[10px]'>
