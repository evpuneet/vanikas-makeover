...
export default function AppointModal() {
  ...
  return (
    <>
        {/* <!-- Main modal --> */}
        <div tabindex="-1" aria-hidden="true" className="backdrop-blur-sm  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[99] justify-center items-center w-full px-[] md:inset-0 max-h-full">
            <div className="relative p-4 w-full max-w-md max-h-full mx-auto my-[50px]">
                {/* <!-- Modal content --> */}
