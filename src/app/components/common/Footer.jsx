  ...
  return (
    <>
        <footer className='grid lg:grid-cols-4 grid-cols-2 gap-x-4 gap-y-6 bg-[#6d0000] text-white py-8 lg:px-14 px-8'>
            ...
            <div>
                <h4 className='mb-4 text-[16px] font-semibold'>Locate Us</h4>
                <ul className='text-[14px] flex flex-col font-light'>
            ...
            <div>
                ...
                <ul className='text-[14px] flex flex-col font-light text-right lg:text-left'>
                    <li className='cursor-pointer '><a href='https://www.instagram.com/vanikkas14' className='hover:underline underline-offset-2 transition-all flex items-center justify-end lg:justify-start gap-1'><RiInstagramFill />Instagram</a></li>
                    <li className='cursor-pointer '><a href='tel:7877446041' className='hover:underline underline-offset-2 transition-all'>+91 7877446041</a></li>
