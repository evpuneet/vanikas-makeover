                ...
                <div className='w-[100vw] h-[100vh] grid lg:grid-cols-2 grid-cols-1 items-center lg:ps-[70px] ps-3 text-white lg:pt-0 pt-[150px]'>
                    <div>
                      ...
                      <div className='flex gap-2'>
                        <button className='bg-white text-primary text-[16px] lg:px-4 px-2 lg:py-2 py-1 rounded-lg' >Book Appointment</button>
                        <button className='text-[16px] lg:px-4 px-2 lg:py-2 py-1 rounded-lg border flex items-center gap-2 hover:shadow'>Salon Locator <IoLocation  className='text-[16px]'/></button>
                      </div>
                    </div>
                    <div className='ps-[40px] md:ps-0]'>
                      <img className='lg:w-[600] w-[300] ' src="https://naturals.in/assets/banner_girl.png" alt="" />
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='w-[100%] h-[100vh] md:bg-banner-2 bg-banner-m-2 bg-no-repeat bg-cover '>
                </div>
            </SwiperSlide>
            </Swiper>
        </div>
